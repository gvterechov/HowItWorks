...
// import * as paper from './paper-core.min';
import * as paper from '../../../../../node_modules/paper/dist/paper-core.min';
export { paper };
...
export function draw_shape(type, config) {
...
export let project;
export function paper_init(canvas_id) {
